...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/martin/mousetest/mousetest.cxs<7>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/martin/mousetest/mousetest.cxs<10>";
...
c_MyApp.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/martin/mousetest/mousetest.cxs<14>";
	print(String(bb_input_MouseZ()));
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/martin/mousetest/mousetest.cxs<22>";
...
c_InputDevice.prototype.p_MouseZ=function(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<77>";
	var t_mZ=this.m__mouseZ;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<78>";
	this.m__mouseZ=0.0;
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<79>";
	pop_err();
	return t_mZ;
}
function c_JoyState(){
...
function bb_input_MouseZ(){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<66>";
	var t_=bb_input_device.p_MouseZ();
	pop_err();
	return t_;
}
function bbInit(){
