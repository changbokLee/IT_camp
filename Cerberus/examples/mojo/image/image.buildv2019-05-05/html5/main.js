...
c_myClass.prototype=extend_class(c_App);
c_myClass.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<9>";
	c_App.m_new.call(this);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<9>";
	pop_err();
	return this;
}
c_myClass.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<13>";
	bb_app_SetUpdateRate(60);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<15>";
	pop_err();
	return 0;
}
c_myClass.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<20>";
	this.m_angle+=0.5;
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<21>";
	if(this.m_angle>360.0){
		err_info="C:/Cerberus/examples/mojo/image/image.cxs<21>";
		this.m_angle-=360.0;
	}
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<22>";
	pop_err();
	return 0;
}
c_myClass.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<27>";
	bb_graphics_Cls(0.0,0.0,128.0);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<28>";
	bb_graphics_SetColor(128.0,128.0,128.0);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<29>";
	bb_graphics_PushMatrix();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<30>";
	bb_graphics_Translate(((bb_app_DeviceWidth()/2)|0),((bb_app_DeviceHeight()/2)|0));
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<31>";
	bb_graphics_Scale(2.0,2.0);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<32>";
	bb_graphics_Rotate(360.0-this.m_angle);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<33>";
	bb_graphics_DrawText("Cerberus X - Mojo template",0,0,.5,.5);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<34>";
	bb_graphics_PopMatrix();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<35>";
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<41>";
	c_myClass.m_new.call(new c_myClass);
	err_info="C:/Cerberus/examples/mojo/image/image.cxs<42>";
	pop_err();
	return 0;
}
