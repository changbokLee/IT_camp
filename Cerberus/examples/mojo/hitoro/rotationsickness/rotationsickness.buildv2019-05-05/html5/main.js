...
c_Game.m_new=function(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<48>";
...
c_Game.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<68>";
	this.m_px=(bb_app_DeviceWidth())*0.5;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<69>";
	this.m_py=(bb_app_DeviceHeight())*0.5;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<71>";
	this.m_player=bb_rotationsickness_LoadCenteredImage("player.png");
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<72>";
	this.m_block=bb_rotationsickness_LoadCenteredImage("block.png");
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<74>";
	this.m_blocklist=c_List.m_new.call(new c_List);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<76>";
	for(var t_loop=1;t_loop<=100;t_loop=t_loop+1){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<77>";
		var t_temp=c_Block.m_new.call(new c_Block);
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<78>";
		dbg_object(t_temp).m_image=this.m_block;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<79>";
		dbg_object(t_temp).m_x=bb_random_Rnd2((-bb_app_DeviceWidth()),(bb_app_DeviceWidth()));
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<80>";
		dbg_object(t_temp).m_y=bb_random_Rnd2((-bb_app_DeviceHeight()),(bb_app_DeviceHeight()));
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<81>";
		this.m_blocklist.p_AddLast(t_temp);
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<84>";
	bb_app_SetUpdateRate(60);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<86>";
	this.m_rotatemode=1;
	pop_err();
	return 0;
}
c_Game.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<92>";
	if((bb_input_KeyDown(37))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<92>";
		this.m_pxs=this.m_pxs-0.1;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<93>";
	if((bb_input_KeyDown(39))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<93>";
		this.m_pxs=this.m_pxs+0.1;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<95>";
	if((bb_input_KeyDown(38))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<95>";
		this.m_pys=this.m_pys-0.1;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<96>";
	if((bb_input_KeyDown(40))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<96>";
		this.m_pys=this.m_pys+0.1;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<98>";
	if((bb_input_KeyDown(90))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<98>";
		this.m_angspeed=this.m_angspeed-0.01;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<99>";
	if((bb_input_KeyDown(88))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<99>";
		this.m_angspeed=this.m_angspeed+0.01;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<101>";
	if((bb_input_KeyDown(32))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<102>";
		this.m_pxs=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<103>";
		this.m_pys=0.0;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<106>";
	if((bb_input_KeyDown(13))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<106>";
		this.m_angspeed=0.0;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<108>";
	if((bb_input_KeyHit(82))!=0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<110>";
		this.m_rotatemode=this.m_rotatemode+1;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<111>";
		if(this.m_rotatemode>4){
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<111>";
			this.m_rotatemode=1;
		}
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<113>";
		this.m_px=(bb_app_DeviceWidth())*0.5;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<114>";
		this.m_py=(bb_app_DeviceHeight())*0.5;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<116>";
		this.m_pxs=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<117>";
		this.m_pys=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<119>";
		this.m_ang=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<120>";
		this.m_angspeed=0.0;
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<124>";
	this.m_px=this.m_px+this.m_pxs;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<125>";
	this.m_py=this.m_py+this.m_pys;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<127>";
	if(this.m_px<0.0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<128>";
		this.m_pxs=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<129>";
		this.m_px=0.0;
	}else{
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<131>";
		if(this.m_px>(bb_app_DeviceWidth())){
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<132>";
			this.m_pxs=0.0;
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<133>";
			this.m_px=(bb_app_DeviceWidth()-1);
		}
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<137>";
	if(this.m_py<0.0){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<138>";
		this.m_pys=0.0;
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<139>";
		this.m_py=0.0;
	}else{
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<141>";
		if(this.m_py>(bb_app_DeviceHeight())){
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<142>";
			this.m_pys=0.0;
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<143>";
			this.m_py=(bb_app_DeviceHeight()-1);
		}
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<147>";
	this.m_ang=this.m_ang+this.m_angspeed;
	pop_err();
	return 0;
}
c_Game.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<154>";
	bb_graphics_Cls(64.0,96.0,128.0);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<156>";
	var t_1=this.m_rotatemode;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<158>";
	if(t_1==1){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<160>";
		bb_rotationsickness_RotateDisplay(this.m_px,this.m_py,this.m_ang);
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<162>";
		bb_graphics_SetColor(0.0,64.0,0.0);
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<163>";
		bb_graphics_DrawRect((-bb_app_DeviceWidth()),(bb_app_DeviceHeight())*0.5,(bb_app_DeviceWidth())*4.0,(bb_app_DeviceHeight())*3.0);
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<165>";
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<165>";
		...
		while(t_.p_HasNext()){
			...
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<166>";
			bb_graphics_DrawImage2(dbg_object(t_b).m_image,dbg_object(t_b).m_x,dbg_object(t_b).m_y,0.0,0.25,0.25,0);
		}
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<169>";
		bb_rotationsickness_ResetDisplay();
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<174>";
		bb_graphics_DrawImage2(this.m_player,this.m_px,this.m_py,0.0,0.25,0.25,0);
	}else{
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<176>";
		if(t_1==2){
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<178>";
			bb_rotationsickness_RotateDisplay(this.m_px,this.m_py,this.m_ang);
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<180>";
			bb_graphics_SetColor(0.0,64.0,0.0);
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<181>";
			bb_graphics_DrawRect((-bb_app_DeviceWidth()),(bb_app_DeviceHeight())*0.5,(bb_app_DeviceWidth())*4.0,(bb_app_DeviceHeight())*3.0);
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<183>";
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<183>";
			var t_2=this.m_blocklist.p_ObjectEnumerator();
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<183>";
			while(t_2.p_HasNext()){
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<183>";
				var t_b2=t_2.p_NextObject();
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<184>";
				bb_graphics_DrawImage2(dbg_object(t_b2).m_image,dbg_object(t_b2).m_x,dbg_object(t_b2).m_y,0.0,0.25,0.25,0);
			}
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<190>";
			bb_graphics_DrawImage2(this.m_player,this.m_px,this.m_py,0.0,0.25,0.25,0);
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<192>";
			bb_rotationsickness_ResetDisplay();
		}else{
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<194>";
			if(t_1==3){
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<196>";
				bb_rotationsickness_RotateDisplay((bb_app_DeviceWidth())*0.5,(bb_app_DeviceHeight())*0.5,this.m_ang);
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<198>";
				bb_graphics_SetColor(0.0,64.0,0.0);
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<199>";
				bb_graphics_DrawRect((-bb_app_DeviceWidth()),(bb_app_DeviceHeight())*0.5,(bb_app_DeviceWidth())*4.0,(bb_app_DeviceHeight())*3.0);
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<201>";
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<201>";
				var t_3=this.m_blocklist.p_ObjectEnumerator();
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<201>";
				while(t_3.p_HasNext()){
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<201>";
					var t_b3=t_3.p_NextObject();
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<202>";
					bb_graphics_DrawImage2(dbg_object(t_b3).m_image,dbg_object(t_b3).m_x,dbg_object(t_b3).m_y,0.0,0.25,0.25,0);
				}
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<205>";
				bb_rotationsickness_ResetDisplay();
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<207>";
				bb_graphics_DrawImage2(this.m_player,this.m_px,this.m_py,0.0,0.25,0.25,0);
			}else{
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<209>";
				if(t_1==4){
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<211>";
					bb_rotationsickness_RotateDisplay((bb_app_DeviceWidth())*0.5,(bb_app_DeviceHeight())*0.5,this.m_ang);
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<213>";
					bb_graphics_SetColor(0.0,64.0,0.0);
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<214>";
					bb_graphics_DrawRect((-bb_app_DeviceWidth()),(bb_app_DeviceHeight())*0.5,(bb_app_DeviceWidth())*4.0,(bb_app_DeviceHeight())*3.0);
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<216>";
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<216>";
					var t_4=this.m_blocklist.p_ObjectEnumerator();
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<216>";
					while(t_4.p_HasNext()){
						err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<216>";
						var t_b4=t_4.p_NextObject();
						err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<217>";
						bb_graphics_DrawImage2(dbg_object(t_b4).m_image,dbg_object(t_b4).m_x,dbg_object(t_b4).m_y,0.0,0.25,0.25,0);
					}
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<220>";
					bb_graphics_DrawImage2(this.m_player,this.m_px,this.m_py,0.0,0.25,0.25,0);
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<222>";
					bb_rotationsickness_ResetDisplay();
				}
			}
		}
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<226>";
	bb_graphics_SetColor(255.0,255.0,255.0);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<227>";
	bb_graphics_DrawText("[CURSORS - move player] [SPACE - stop player]",20,20,0.0,0.0);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<228>";
	bb_graphics_DrawText("[Z/X - rotate around player] [ENTER - stop rotation]",20,40,0.0,0.0);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<230>";
	var t_mode="";
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<232>";
	var t_22=this.m_rotatemode;
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<233>";
	if(t_22==1){
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<234>";
		t_mode="Rotate around player (controls relative to screen)";
	}else{
		err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<235>";
		if(t_22==2){
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<236>";
			t_mode="Rotate with player (controls relative to background)";
		}else{
			err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<237>";
			if(t_22==3){
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<238>";
				t_mode="Rotate around centre (controls relative to screen)";
			}else{
				err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<239>";
				if(t_22==4){
					err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<240>";
					t_mode="Rotate around centre (controls relative to background)";
				}
			}
		}
	}
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<243>";
	bb_graphics_DrawText("[R - change rotation mode: "+t_mode,20,60,0.0,0.0);
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<252>";
...
function bb_rotationsickness_MidHandle(t_image){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<258>";
	t_image.p_SetHandle((t_image.p_Width())*0.5,(t_image.p_Height())*0.5);
	pop_err();
	return 0;
}
function bb_rotationsickness_LoadCenteredImage(t_image){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<264>";
	var t_img=bb_graphics_LoadImage(t_image,1,c_Image.m_DefaultFlags);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<265>";
	bb_rotationsickness_MidHandle(t_img);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<266>";
	pop_err();
	return t_img;
}
function c_Block(){
...
c_Block.m_new=function(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<40>";
	pop_err();
	return this;
}
function c_List(){
...
function bb_rotationsickness_RotateDisplay(t_x,t_y,t_angle){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<26>";
	bb_graphics_PushMatrix();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<27>";
	bb_graphics_Translate(t_x,t_y);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<28>";
	bb_graphics_Rotate(t_angle);
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<29>";
	bb_graphics_Translate(-t_x,-t_y);
	pop_err();
	return 0;
}
...
function bb_rotationsickness_ResetDisplay(){
	push_err();
	err_info="C:/IT_camp/Cerberus/examples/mojo/hitoro/rotationsickness/rotationsickness.cxs<37>";
	bb_graphics_PopMatrix();
	pop_err();
	return 0;
}
