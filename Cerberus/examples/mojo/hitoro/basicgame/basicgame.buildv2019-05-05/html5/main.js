...
c_RocketGame.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<6>";
...
c_RocketGame.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<19>";
	this.m_player=c_Rocket.m_new.call(new c_Rocket);
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<23>";
	dbg_object(this.m_player).m_image=bb_graphics_LoadImage("player.png",1,1);
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<27>";
...
c_RocketGame.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<35>";
	this.m_mx=bb_input_MouseX();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<36>";
	this.m_my=bb_input_MouseY();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<38>";
...
c_RocketGame.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<46>";
	bb_graphics_Cls(32.0,64.0,128.0);
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<50>";
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<87>";
...
c_Rocket.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<58>";
	pop_err();
	return this;
}
c_Rocket.prototype.p_MovePlayer=function(t_towardsx,t_towardsy){
	push_err();
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<71>";
	var t_xdist=t_towardsx-this.m_x;
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<72>";
	var t_ydist=t_towardsy-this.m_y;
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<74>";
	var t_xstep=t_xdist/this.m_mousediv;
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<75>";
	var t_ystep=t_ydist/this.m_mousediv;
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<77>";
	this.m_x=this.m_x+t_xstep;
	err_info="C:/Cerberus/examples/mojo/hitoro/basicgame/basicgame.cxs<78>";
