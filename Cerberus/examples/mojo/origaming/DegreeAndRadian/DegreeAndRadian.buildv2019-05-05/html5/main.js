...
//${METADATA_BEGIN}
var META_DATA="[DegreeAndRadian.png];type=image/png;width=125;height=79;\n[mojo_font.png];type=image/png;width=864;height=13;\n";
//${METADATA_END}
...
function c_DegreeAndRadian(){
	c_App.call(this);
	this.m_DegreeAndRadian=null;
	this.m_angle=.0;
}
c_DegreeAndRadian.prototype=extend_class(c_App);
c_DegreeAndRadian.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<7>";
	c_App.m_new.call(this);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<7>";
	pop_err();
	return this;
}
c_DegreeAndRadian.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<11>";
	bb_app_SetUpdateRate(30);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<13>";
	this.m_DegreeAndRadian=c_myObject.m_new.call(new c_myObject);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<14>";
	dbg_object(this.m_DegreeAndRadian).m_mainImage=bb_graphics_LoadImage("DegreeAndRadian.png",1,c_Image.m_DefaultFlags);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<16>";
	dbg_object(this.m_DegreeAndRadian).m_mainImage.p_SetHandle(0.0,((dbg_object(this.m_DegreeAndRadian).m_mainImage.p_Height()/2)|0));
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<18>";
	dbg_object(this.m_DegreeAndRadian).m_x=((bb_app_DeviceWidth()/2)|0);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<19>";
	dbg_object(this.m_DegreeAndRadian).m_y=((bb_app_DeviceHeight()/2)|0);
	pop_err();
	return 0;
}
c_DegreeAndRadian.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<23>";
	var t_theX=bb_input_MouseX()-dbg_object(this.m_DegreeAndRadian).m_x;
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<24>";
	var t_theY=(bb_input_MouseY()-dbg_object(this.m_DegreeAndRadian).m_y)*-1.0;
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<25>";
	this.m_angle=(Math.atan(t_theY/t_theX)*R2D);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<26>";
	if(t_theX<0.0){
		err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<27>";
		this.m_angle=this.m_angle+180.0;
	}
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<29>";
	if(t_theX>=0.0 && t_theY<0.0){
		err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<30>";
		this.m_angle=this.m_angle+360.0;
	}
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<33>";
	dbg_object(this.m_DegreeAndRadian).m_rotation=this.m_angle;
	pop_err();
	return 0;
}
c_DegreeAndRadian.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<37>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<39>";
	bb_graphics_DrawText("Degree "+String(this.m_angle),0,0,0.0,0.0);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<40>";
	bb_graphics_DrawText("Radian "+String(this.m_angle*3.14159265/180.0),0,20,0.0,0.0);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<42>";
	this.m_DegreeAndRadian.p_Draw();
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<4>";
	c_DegreeAndRadian.m_new.call(new c_DegreeAndRadian);
	pop_err();
	return 0;
}
...
c_myObject.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<46>";
	pop_err();
	return this;
}
c_myObject.prototype.p_Draw=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<55>";
	if(!this.m_visible){
		pop_err();
		return;
	}
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<56>";
	bb_graphics_SetAlpha(this.m_alpha);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<57>";
	bb_graphics_DrawImage2(this.m_mainImage,this.m_x,this.m_y,this.m_rotation,this.m_scaleX,this.m_scaleY,0);
	err_info="C:/Cerberus/examples/mojo/origaming/DegreeAndRadian/DegreeAndRadian.cxs<58>";
	bb_graphics_SetAlpha(1.0);
	pop_err();
}
