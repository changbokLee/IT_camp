...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<6>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<9>";
	bb_app_SetUpdateRate(15);
	pop_err();
	return 0;
}
...
c_MyApp.prototype.p_Format=function(t_n){
	push_err();
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<16>";
	var t_i=((t_n*100.0)|0);
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<17>";
	if(t_i>99){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<17>";
		pop_err();
		return "+1.00";
	}
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<18>";
	if(t_i<-99){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<18>";
		pop_err();
		return "-1.00";
	}
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<19>";
	if(t_i>9){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<19>";
		var t_="+0."+String(t_i);
		pop_err();
	...
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<20>";
	if(t_i<-9){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<20>";
		var t_2="-0."+String(-t_i);
		pop_err();
		return t_2;
	}
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<21>";
	if(t_i>0){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<21>";
		var t_3="+0.0"+String(t_i);
		pop_err();
		return t_3;
	}
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<22>";
	if(t_i<0){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<22>";
		var t_4="-0.0"+String(-t_i);
		pop_err();
		return t_4;
	}
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<23>";
	pop_err();
	return " 0.00";
}
c_MyApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<27>";
	bb_graphics_Scale((bb_app_DeviceWidth())/400.0,(bb_app_DeviceHeight())/440.0);
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<28>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<29>";
	for(var t_port=0;t_port<4;t_port=t_port+1){
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<30>";
		if((bb_input_JoyHit(14,t_port))!=0){
			err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<30>";
			print("Bong!");
		}
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<31>";
		bb_graphics_PushMatrix();
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<32>";
		bb_graphics_Translate((t_port*100),0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<33>";
		bb_graphics_DrawText("Port "+String(t_port),0,0,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<34>";
		bb_graphics_DrawText("JoyX(0) "+this.p_Format(bb_input_JoyX(0,t_port)),0,20,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<35>";
		bb_graphics_DrawText("JoyY(0) "+this.p_Format(bb_input_JoyY(0,t_port)),0,40,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<36>";
		bb_graphics_DrawText("JoyZ(0) "+this.p_Format(bb_input_JoyZ(0,t_port)),0,60,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<37>";
		bb_graphics_DrawText("JoyX(1) "+this.p_Format(bb_input_JoyX(1,t_port)),0,80,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<38>";
		bb_graphics_DrawText("JoyY(1) "+this.p_Format(bb_input_JoyY(1,t_port)),0,100,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<39>";
		bb_graphics_DrawText("JoyZ(1) "+this.p_Format(bb_input_JoyZ(1,t_port)),0,120,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<40>";
		bb_graphics_DrawText("JOY_A       "+String(bb_input_JoyDown(0,t_port)),0,140,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<41>";
		bb_graphics_DrawText("JOY_B       "+String(bb_input_JoyDown(1,t_port)),0,160,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<42>";
		bb_graphics_DrawText("JOY_X       "+String(bb_input_JoyDown(2,t_port)),0,180,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<43>";
		bb_graphics_DrawText("JOY_Y       "+String(bb_input_JoyDown(3,t_port)),0,200,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<44>";
		bb_graphics_DrawText("JOY_LB      "+String(bb_input_JoyDown(4,t_port)),0,220,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<45>";
		bb_graphics_DrawText("JOY_RB      "+String(bb_input_JoyDown(5,t_port)),0,240,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<46>";
		bb_graphics_DrawText("JOY_BACK    "+String(bb_input_JoyDown(6,t_port)),0,260,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<47>";
		bb_graphics_DrawText("JOY_START   "+String(bb_input_JoyDown(7,t_port)),0,280,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<48>";
		bb_graphics_DrawText("JOY_LEFT    "+String(bb_input_JoyDown(8,t_port)),0,300,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<49>";
		bb_graphics_DrawText("JOY_UP      "+String(bb_input_JoyDown(9,t_port)),0,320,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<50>";
		bb_graphics_DrawText("JOY_RIGHT   "+String(bb_input_JoyDown(10,t_port)),0,340,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<51>";
		bb_graphics_DrawText("JOY_DOWN    "+String(bb_input_JoyDown(11,t_port)),0,360,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<52>";
		bb_graphics_DrawText("JOY_LSB     "+String(bb_input_JoyDown(12,t_port)),0,380,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<53>";
		bb_graphics_DrawText("JOY_RSB     "+String(bb_input_JoyDown(13,t_port)),0,400,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<54>";
		bb_graphics_DrawText("JOY_MENU    "+String(bb_input_JoyDown(14,t_port)),0,420,0.0,0.0);
		err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<55>";
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/mojo/mak/joytest/joytest.cxs<63>";
...
c_InputDevice.prototype.p_JoyZ=function(t_index,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/inputdevice.cxs<130>";
	pop_err();
	return dbg_array(dbg_object(dbg_array(this.m__joyStates,t_unit)[dbg_index]).m_joyz,t_index)[dbg_index];
}
...
function bb_input_JoyHit(t_button,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<132>";
...
function bb_input_JoyX(t_index,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<116>";
...
function bb_input_JoyY(t_index,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<120>";
	var t_=bb_input_device.p_JoyY(t_index,t_unit);
	pop_err();
	return t_;
}
function bb_input_JoyZ(t_index,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<124>";
	var t_=bb_input_device.p_JoyZ(t_index,t_unit);
	pop_err();
	return t_;
}
function bb_input_JoyDown(t_button,t_unit){
	push_err();
	err_info="C:/Cerberus/modules/mojo/input.cxs<128>";
