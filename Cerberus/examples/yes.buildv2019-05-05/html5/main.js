...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Cerberus/examples/yes.cxs<3>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/examples/yes.cxs<8>";
	this.m_lineY=((bb_app_DeviceHeight()/2)|0);
	err_info="C:/Cerberus/examples/yes.cxs<9>";
...
c_MyApp.prototype.p_OnUpdate=function(){
	push_err();
	err_info="C:/Cerberus/examples/yes.cxs<14>";
	var t_hit=bb_input_KeyHit(1);
	err_info="C:/Cerberus/examples/yes.cxs<16>";
	if(((t_hit)!=0) && bb_input_MouseY()<(this.m_lineY)){
		err_info="C:/Cerberus/examples/yes.cxs<17>";
		print("You clicked above the line.");
	}else{
		err_info="C:/Cerberus/examples/yes.cxs<18>";
		if(((t_hit)!=0) && bb_input_MouseY()>=(this.m_lineY)){
			err_info="C:/Cerberus/examples/yes.cxs<19>";
...
c_MyApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/examples/yes.cxs<24>";
	bb_graphics_Cls(0.0,0.0,0.0);
	err_info="C:/Cerberus/examples/yes.cxs<25>";
	bb_graphics_DrawLine(0.0,(this.m_lineY),(bb_app_DeviceWidth()),(this.m_lineY));
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/examples/yes.cxs<30>";
