...
c_MyApp.m_new=function(){
	push_err();
	err_info="C:/Cerberus/game.cxs<6>";
...
c_MyApp.prototype.p_OnCreate=function(){
	push_err();
	err_info="C:/Cerberus/game.cxs<14>";
	this.p_LoadGame();
	err_info="C:/Cerberus/game.cxs<15>";
...
c_MyApp.prototype.p_OnRender=function(){
	push_err();
	err_info="C:/Cerberus/game.cxs<30>";
	bb_graphics_Cls(0.0,0.0,0.0);
	pop_err();
	return 0;
}
c_MyApp.prototype.p_OnLoading=function(){
	push_err();
	pop_err();
	return 0;
}
...
function bbMain(){
	push_err();
	err_info="C:/Cerberus/game.cxs<40>";
