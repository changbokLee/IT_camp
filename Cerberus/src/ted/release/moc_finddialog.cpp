...
QT_MOC_LITERAL(1, 11, 11), // "findReplace"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 3), // "how"
QT_MOC_LITERAL(4, 28, 10), // "onFindNext"
QT_MOC_LITERAL(5, 39, 9), // "onReplace"
QT_MOC_LITERAL(6, 49, 12) // "onReplaceAll"

    },
    "FindDialog\0findReplace\0\0how\0onFindNext\0"
    "onReplace\0onReplaceAll"
};
...
void FindDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->findReplace((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FindDialog::findReplace)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FindDialog::findReplace(int _t1)
{
